...
def joint_probability(people, one_gene, two_genes, have_trait):
    ...
    for person in people:
        ...
        # Start with unconditional probability for the gene
        if people[person]["mother"] is None and people[person]["father"] is None:
            # No parents, use unconditional probability
            gene_prob = PROBS["gene"][genes]
        else:
            # Parents exist, use conditional probability based on parents
            mother = people[person]["mother"]
            father = people[person]["father"]

            # Probabilities that each parent passes the gene
            ...
            # Calculate the probability of `person` having `genes` number of genes
            if genes == 2:
        ...
        # Get the probability of the trait
        trait_prob = PROBS["trait"][genes][person in have_trait]

        # Multiply joint probability by this person's gene and trait probabilities
